#!/bin/bash
# Polar 6-family Prompt/FiLM specialization. Not official --tune.
# Train on generated instances of that family's types; eval on labeled test.
...
TRAIN_MODULES="${TRAIN_MODULES:-prompt}"   # prompt | prompt_film | all
